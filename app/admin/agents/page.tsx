...
import AgentEconomyReportPanel from "@/components/admin/agents/AgentEconomyReportPanel";
      ...
      if (
        ...
        setNotice(
          payload
            ...
            ?.email
            ?.sent
            ? `Failure alert sent through Resend to ${
                payload
                  .result
                  .email
                  .recipient ||
        ...
        setNotice(
          "Emergency stop applied. Engine is off and any active agents were paused.",
        );
      } else {
        setNotice(
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#020813] px-4 py-6 text-white sm:px-7 sm:py-8">
      ...
      <div className="relative z-10 mx-auto max-w-[1600px]">
        <header className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-4 max-w-3xl text-sm leading-6 text-white/52 sm:text-base">
              Phase 3 runtime safety, pilot staging,
              failure reporting and population controls.
            </p>
          </div>
        ...
        {notice && (
          <div className="mt-5 rounded-2xl border border-emerald-300/20 bg-emerald-400/[0.06] px-5 py-4 text-sm text-emerald-100">
            {notice}
          </div>
        )}
        ...
        <section className="mt-8 grid gap-3 sm:grid-cols-2 xl:grid-cols-6">
          <Metric
            ...
            description="Real simulation identities"
          />
          ...
          <Metric
            ...
            description="Phase 3 staged cohort"
          />
          ...
          <Metric
            ...
            description="Current agent DG"
          />
        </section>

        {/* ================================================================
            PHASE 4B-2B — CURRENT ECONOMY / MARKET / PROPERTY REPORT
            ================================================================ */}
        <AgentEconomyReportPanel
          failureEmailRecipient={
            runtime.failureEmailRecipient
          }
        />
            ...
            <div className="mt-5 flex items-center justify-between gap-4 rounded-2xl border border-white/10 bg-[#061632]/70 p-5">
              <div>
                ...
                <p className="mt-1 text-xs leading-5 text-white/45">
                  Activation remains hard-locked until
                  Brain V1, executable adapters and the
            ...
            <button
              ...
              onClick={() =>
                void runtimeAction(
                  ...
                  {
                    reason:
                      "Emergency stop from Phase 3 Agent Control Centre.",
                  },
                )
              }
              className="mt-5 min-h-12 w-full rounded-2xl border border-rose-300/25 bg-rose-400/10 px-5 text-sm font-black text-rose-100 disabled:opacity-40"
            >
              Emergency Stop
            </button>
          </article>
          ...
          <article className="rounded-[28px] border border-violet-200/12 bg-[linear-gradient(145deg,rgba(33,21,69,0.48),rgba(5,18,40,0.72))] p-6 backdrop-blur-xl">
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-2">
              {[
                [
                  "Simulated day",
                  `${runtime.simulationDayDurationMinutes} real minutes`,
                ],
                [
                  "Sessions / day",
                  `${runtime.minSessionsPerSimDay}–${runtime.maxSessionsPerSimDay}`,
                ],
                [
                  "Decisions / session",
                  `${runtime.minDecisionsPerSession}–${runtime.maxDecisionsPerSession}`,
                ],
                [
                  "DT daily spend cap",
                  `min(${Math.round(
                    runtime.maxDailyDtSpendFraction *
                      100,
                  )}% balance, ${formatNumber(
                    runtime.maxDailyDtSpendAbsolute,
                  )} DT)`,
                ],
                [
                  "DG daily spend cap",
                  `${runtime.maxDailyDgSpend} DG`,
                ],
                [
                  "Auto-pause",
                  `${runtime.autoPauseFailureThreshold} consecutive failures`,
                ],
              ].map(
                (
                  [
        ...
        <section className="mt-6 rounded-[30px] border border-cyan-300/14 bg-cyan-300/[0.035] p-5 sm:p-6">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-white/45">
                4 Nova · 3 Milo · 3 Both. All remain
                dormant in Phase 3A.
              </p>
            </div>

            <div className="flex gap-2 text-xs font-black">
              <span className="rounded-full border border-cyan-300/16 bg-cyan-300/[0.06] px-3 py-2">
                Nova{" "}
                {pilotCounts.nova ||
                  0}
              </span>

              <span className="rounded-full border border-violet-300/16 bg-violet-300/[0.06] px-3 py-2">
                Milo{" "}
                {pilotCounts.milo ||
                  0}
              </span>
          ...
          <div className="mt-5 overflow-x-auto rounded-2xl border border-white/8">
            <table className="w-full min-w-[820px] border-collapse text-left">
              <thead className="bg-[#061632]/90 text-[10px] font-black uppercase tracking-[0.12em] text-white/40">
                <tr>
                  ...
                  .map(
                    (
                      ...
                      >
                        ...
                        <td className="px-4 py-4 text-xs capitalize text-white/65">
                          {
                            agent.worldAffinity
                          }
                        </td>
                        ...
                        <td className="px-4 py-4">
                          <span
                            className={`rounded-full border px-3 py-1.5 text-[10px] font-black uppercase ${statusClasses(
                              agent.pilotStatus,
                            )}`}
                          >
                            {titleCase(
                        ...
                        <td className="px-4 py-4">
                          ...
                          "paused" ? (
                            <button
                              ...
                              className="rounded-full border border-cyan-300/20 bg-cyan-300/[0.07] px-3 py-2 text-[10px] font-black uppercase disabled:opacity-40"
                            >
                              Resume Dormant
                            </button>
                          ) : (
                            <button
                              ...
                              className="rounded-full border border-amber-300/20 bg-amber-300/[0.07] px-3 py-2 text-[10px] font-black uppercase disabled:opacity-40"
                            >
                              Pause
                            </button>
                          )}
        ...
        <section className="mt-6 grid gap-5 xl:grid-cols-[0.72fr_1.28fr]">
          <article className="rounded-[28px] border border-rose-300/12 bg-rose-300/[0.035] p-6">
            <p className="text-xs font-extrabold uppercase tracking-[0.2em] text-rose-100">
              Failure Alerts
            </p>
            ...
            <p className="mt-3 text-sm leading-6 text-white/45">
              Agent, orchestrator, action and system
              failures are recorded durably and
              immediately reported through Resend.
            </p>
            ...
            <div className="mt-4 grid gap-2">
              <button
                ...
                className="min-h-11 rounded-2xl border border-rose-300/20 bg-rose-300/[0.08] px-4 text-xs font-black uppercase tracking-[0.1em] disabled:opacity-40"
              >
                Send Failure Email Test
              </button>
              ...
              <button
                ...
                onClick={() =>
                  void runtimeAction(
                    "retry_failure_emails",
                  )
                }
                className="min-h-11 rounded-2xl border border-white/10 bg-white/[0.04] px-4 text-xs font-black uppercase tracking-[0.1em] disabled:opacity-40"
              >
                Retry Unsent Alerts
              </button>
            </div>
          ...
          <article className="rounded-[28px] border border-white/10 bg-white/[0.04] p-6">
            ...
            <div className="mt-5 max-h-[410px] space-y-2 overflow-y-auto pr-1">
              {runtime
                ...
                .length ===
              0 ? (
                <div className="rounded-2xl border border-white/8 bg-white/[0.03] p-5 text-sm text-white/40">
                    ...
                    (
                      ...
                      >
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          {failure.autoPaused && (
                            <span className="rounded-full border border-amber-300/20 bg-amber-300/[0.07] px-2 py-1 text-[9px] font-black uppercase text-amber-100">
                              Auto-paused
                            </span>
                          )}
                        </div>
        ...
        <section className="mt-6 rounded-[28px] border border-violet-200/12 bg-[linear-gradient(145deg,rgba(33,21,69,0.45),rgba(5,18,40,0.72))] p-6">
          ...
          <p className="mt-2 text-sm text-white/45">
            Locked OFF throughout the initial Phase 3
            pilot.
          </p>
          ...
          <div className="mt-5 grid gap-3 lg:grid-cols-3">
            <Toggle
              ...
              description="Locked until the pilot is reviewed."
              checked={
                settings.publicVisibilityEnabled
              }
              disabled={
                !runtime.publicVisibilityUnlocked ||
                busyAction !==
                  null
              }
              onChange={(
            ...
            <Toggle
              title="Leaderboards"
              description="Agents remain hidden from public leaderboards."
              checked={
            ...
            <Toggle
              title="Milo Exchange"
              description="Agent Exchange activity remains hidden."
              checked={
                ...
                {filteredAgents.map(
                  (
                    ...
                    <tr
                      ...
                      className="border-t border-white/[0.07] align-top hover:bg-white/[0.025]"
                    >
                      <td className="px-4 py-4">
                        <strong className="block text-sm">
                          {
                      ...
                      <td className="px-4 py-4 text-xs">
                        <strong className="block text-[#ffd18a]">
                          {formatNumber(
                            agent.currentDt ??
                        ...
                        <span className="mt-1 block text-violet-200/70">
                          {formatNumber(
                            agent.currentDg ??
        ...
        <section className="mt-6 rounded-3xl border border-cyan-300/12 bg-cyan-300/[0.035] p-5">
          <p className="text-xs font-extrabold uppercase tracking-[0.18em] text-cyan-100">
            Phase 3A Safety State
          </p>

          <p className="mt-3 text-sm leading-6 text-white/48">
            The 10-agent pilot is staged but not active.
            The simulation clock has not started, runtime
            execution is disabled for every agent,
            real-world action contracts remain
            non-executable, and public visibility remains
            locked off.
          </p>
        </section>
      </div>
