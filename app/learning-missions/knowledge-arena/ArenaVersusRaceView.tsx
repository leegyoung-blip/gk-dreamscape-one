...
const novaFilters: Record<string, string> = {
  azure: "none",
  violet: "hue-rotate(62deg) saturate(1.08)",
  crimson: "hue-rotate(155deg) saturate(1.25)",
  emerald: "hue-rotate(285deg) saturate(1.08)",
  gold: "sepia(.42) saturate(1.8) hue-rotate(355deg) brightness(1.12)",
};
      ...
      <div className="kavr-track-wrap">
        ...
        <div className="kavr-track">
          ...
          {standings.map((player,index) => {
            ...
            const isNova = player.character_type !== "monster";
            return (
              <div key={player.id} className={`kavr-lane ${player.id === myPlayerId ? "is-me" : ""}`}>
                ...
                <div className="kavr-runner" style={{ left:`${percent}%` }}>
                  {src && <img src={src} alt="" draggable={false} style={{ filter:isNova ? (novaFilters[player.character_slug || "azure"] || "none") : "none" }} />}
