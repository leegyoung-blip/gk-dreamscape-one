...
<html>
          ...
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:620px;overflow:hidden;border:1px solid #24435f;border-radius:24px;background:#0a1730;">
            <tr>
              <td style="padding:28px 30px;background:linear-gradient(135deg,#0c3450,#26134d);">
                ...
                <div style="margin-top:10px;font-size:28px;font-weight:800;line-height:1.2;color:#ffffff;">Change your parent PIN</div>
              </td>
            </tr>
            <tr>
              <td style="padding:30px;">
                <p style="margin:0;font-size:15px;line-height:1.75;color:#c9d7e8;">
                  A parent PIN change was requested for a learner account you control.
                </p>
                ...
                <div style="margin-top:28px;text-align:center;">
                  <a href="${safeUrl}" style="display:inline-block;border-radius:999px;background:linear-gradient(135deg,#35c5ff,#7c5cff);padding:14px 24px;color:#ffffff;text-decoration:none;font-size:14px;font-weight:800;">Change parent PIN</a>
                </div>
                <p style="margin:26px 0 0;font-size:12px;line-height:1.7;color:#7f91a8;">
                  If you did not request this change, you can safely ignore this email. The existing parent PIN remains active.<br><br>
  ...
  const response = await fetch("https://api.resend.com/emails", {
    ...
    body: JSON.stringify({
      ...
      subject: "Change your Dreamscape parent PIN",
      html,
      tags: [
